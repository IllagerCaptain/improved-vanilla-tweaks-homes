...
public class HomeCommandExecutedProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (dependencies.get("cmdparams") == null) {
			System.err.println("Failed to load dependency cmdparams for procedure HomeCommandExecuted!");
			return;
		}
		...
		if ((new Object() {
		...
		}.getText())).equals(""))) {
			{
				Entity _ent = entity;
				if (!_ent.world.isClient()) {
					_ent.world.getServer().getCommandManager().execute(_ent.getCommandSource().withSilent().withLevel(4), "trigger home");
				}
			}
		}
	}
